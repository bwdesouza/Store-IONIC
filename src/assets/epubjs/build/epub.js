...
EPUBJS.Book.prototype.open = function (bookPath, forceReload) {
	...
	console.log("Bws - Open: " + bookPath)

	var book = this,
		epubpackage,
		opened = new RSVP.defer();

	//console.log("Pedro - Open - book: " + JSON.stringify(book));
	...
	if (this.settings.contained || this.isContained(bookPath)) {
		...
		epubpackage = this.unarchive(bookPath).
			...
			console.log("Bws - EPUBPACKAGE: " + JSON.stringify(epubpackage))
		} else {
			...
			console.log("Bws - ELSE EPUBPACKAGE: " + epubpackage)
		}
		...
		console.log("Bws - REBDERER: " + JSON.stringify(this.renderer))
...
EPUBJS.core.uri = function (url) {
	...
	//console.log("Pedro - URI: " + JSON.stringify(uri));
...
EPUBJS.Layout.Reflowable.prototype.calculatePages = function () {
	...
	console.log("calcularPagina - " + totalWidth + ' - ' + this.spreadWidth);
	debugger
	return {
...
EPUBJS.Layout.ReflowableSpreads.prototype.calculatePages = function () {
	...
	console.log("calculando pagina 2")
	return {
		displayedPages: displayedPages,
